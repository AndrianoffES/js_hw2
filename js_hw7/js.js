...
const game = {
    ...
    play() {
        ...
        this.obstacleInterval = setInterval(() => this.obstacle.setCoordinates(this.getRandomFreeCoordinates()), 3000);
    ...
    checkPoints(){
        const scorePoint = this.snake.body.length -1;
        const score = document.getElementById('score');
        score.innerText = `Счет: ${scorePoint}`
    },
